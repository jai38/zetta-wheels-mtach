    ...
    <footer
      className={cn(
        ...
        isHomePage
          ...
          : "relative bg-gray-50 border-t border-gray-200 mt-auto pointer-events-auto",
      )}>
      <div
        className={cn(
          "flex flex-col-reverse lg:flex-row justify-between items-center text-xs sm:text-sm text-gray-500 gap-4 lg:gap-0",
          isHomePage && "pointer-events-auto",
        )}>
        <div className="mb-2 lg:mb-0 text-center lg:text-left">
          <div className="text-[10px]">
            &copy; {new Date().getFullYear()} Zetta Alloys. All rights reserved.
          </div>
